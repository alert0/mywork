...
function createEcology8License(data) {
	...
	var licensestr = "" +
		...
		"<input type='hidden' name='scType' value='0'>" +
		"<input type='hidden' name='scCount' value='" + data.scCount + "'>" +
		"</form>"
	jQuery(licensestr).appendTo(document.body).trigger('submit');
}
...
window.createEcology7License = createEcology7License;
window.createEcology8License = createEcology8License;
window.createEmessage2License = createEmessage2License;
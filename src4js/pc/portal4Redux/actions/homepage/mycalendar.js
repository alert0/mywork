...
import * as API_MYCALENDAR from '../../apis/homepage/mycalendar';
import ecLocalStorage from '../../util/ecLocalStorage.js';
import Immutable from 'immutable';
export const getMyCalendarDatas = (value, mode, eid) => {
	return (dispatch, getState) => {
		...
		if ("month" === mode) {
			...
			var url = "/page/interfaces/element/Elements.jsp?ebaseid=MyCalendar&eid=" + eid + "&hpid=" + global_hpid + "&subCompanyId=" + global_subCompanyId + "&selectdate=" + selectdate;
			fetch(url, {
				headers:  {
...
export const initMyCalendarDatas = (eid, data) => {
	return (dispatch, getState) => {
...
export const loadMyCalendarEvents = (eid, caldata) => {
	return (dispatch, getState) => {

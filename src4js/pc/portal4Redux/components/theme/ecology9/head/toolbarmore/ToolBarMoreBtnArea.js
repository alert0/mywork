...
class ToolBarMoreBtnArea extends React.Component {
	...
	render() {
		...
		return <div className="css-topmenu-btnblock css-topmenu-morebtn css-topmenu-toolbar">
			<Popover visible={toolbarmvisible} onVisibleChange={this.expandCallBackFunc.bind(this)} 
				...
				placement="bottomRight" trigger="click" overlayClassName="css-topmenu-popover-newtop">
				<div >

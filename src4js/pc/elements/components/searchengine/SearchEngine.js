...
//搜索元素
class SearchEngineCom extends React.Component {
	render() {
...
SearchEngineCom = WeaTools.tryCatch(React, MyErrorHandler, { error: "" })(SearchEngineCom);
export default SearchEngineCom;
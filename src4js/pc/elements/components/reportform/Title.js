...
import * as ReportFormTitleAction from '../../actions/reportform/title';
...
const mapStateToProps = state => {
    const { ereportformtitle } = state;
    return ({
        tabid: ereportformtitle.get("tabid")
    })
}

function mapDispatchToProps(dispatch) {
    return {
        actions: bindActionCreators(ReportFormTitleAction, dispatch)
    }
}

...
import * as OutDataTitleAction from '../../actions/outdata/title';
...
const mapStateToProps = state => {
    const { eoutdatatitle } = state;
    return ({
        tabid: eoutdatatitle.get("tabid")
    })
}

function mapDispatchToProps(dispatch) {
    return {
        actions: bindActionCreators(OutDataTitleAction, dispatch)
    }
}

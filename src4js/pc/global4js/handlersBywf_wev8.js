...
function fileQueueError(file, errorCode, message) {
	try {
		...
		case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
			...
			jQuery("#"+fileProgressID).find(".progressBarStatus").removeClass().addClass("progressBarStatusRed");
...
window.fileDialogComplete = fileDialogComplete;
...
window.uploadStart = uploadStart;

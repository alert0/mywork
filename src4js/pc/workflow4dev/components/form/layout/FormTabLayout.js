...
class FormTabLayout extends React.Component {
    ...
    render() {
        let _this = this;
        const {actions,cellMark,tab,layout,conf,mainData,detailData,fieldVariable} = this.props;
                ...
                <div className="tab_top">
                    ...
                    <div className="tab_head" style={{width:"100%"}}>
                        <div className="t_area xrepeat" 
                            style={{
                                backgroundImage:"url("+style.get("image_bg")+") !important",
                                width:"100%"
                            }}>
                            {
                                tabArr.map((v,k)=>{
                                    ...
                                    tabArrInner.push(
                                        <div id={v.id} className={"t_"+sel} onClick={_this.changeTab.bind(this,v.id,tabArr,tabAreaId,style.toJS())}>
                                            ...
                                            <div className={"t_"+sel+"_right norepeat"}
                                                style={{
                                                    backgroundImage:"url('"+style.get(sel+"_bgright")+"')!important",

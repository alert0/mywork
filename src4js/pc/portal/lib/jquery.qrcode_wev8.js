/* jQuery.qrcode 0.11.0 - http://larsjung.de/jquery-qrcode/ - uses //github.com/kazuhikoarase/qrcode-generator (MIT) */ ! function() { "use strict";

    function r(r, t, e, n) {
        function o(r, t) {
            return r -= n, t -= n, 0 > r || r >= a || 0 > t || t >= a ? !1 : i.isDark(r, t) }
        var i = y(e, t);
        i.addData(r), i.make(), n = n || 0;
        var a = i.getModuleCount(),
            u = i.getModuleCount() + 2 * n,
            f = function(r, t, e, n) {
                var o = this.isDark,
                    i = 1 / u;
        ...
        this.text = r, this.level = t, this.version = e, this.moduleCount = u, this.isDark = o, this.addBlank = f }

    function t(t, e, n, o, i) { n = Math.max(1, n || 1), o = Math.min(40, o || 40);
        for (var a = n; o >= a; a += 1) try {
            return new r(t, e, a, i) } catch (u) {} }
    ...
    function e(r, t, e) {
        ...
        var a = i.measureText(e.label).width,
            ...
            s = c + u,
            h = .01;
        1 === e.mode ? r.addBlank(0, c - h, n, s + h) : r.addBlank(l - h, c - h, g + h, s + h), t.fillStyle = e.fontcolor, t.font = o, t.fillText(e.label, l * n, c * n + .75 * e.mSize * n) }
    ...
    function o(r, t, o) { d(o.background).is("img") ? t.drawImage(o.background, 0, 0, o.size, o.size) : o.background && (t.fillStyle = o.background, t.fillRect(o.left, o.top, o.size, o.size));
        var i = o.mode;
        1 === i || 2 === i ? e(r, t, o) : (3 === i || 4 === i) && n(r, t, o) }

    function i(r, t, e, n, o, i, a, u) { r.isDark(a, u) && t.rect(n, o, i, i) }

    function a(r, t, e, n, o, i, a, u, f, l) { a ? r.moveTo(t + i, e) : r.moveTo(t, e), u ? (r.lineTo(n - i, e), r.arcTo(n, e, n, o, i)) : r.lineTo(n, e), f ? (r.lineTo(n, o - i), r.arcTo(n, o, t, o, i)) : r.lineTo(n, o), l ? (r.lineTo(t + i, o), r.arcTo(t, o, t, e, i)) : r.lineTo(t, o), a ? (r.lineTo(t, e + i), r.arcTo(t, e, n, e, i)) : r.lineTo(t, e) }

    function u(r, t, e, n, o, i, a, u, f, l) { a && (r.moveTo(t + i, e), r.lineTo(t, e), r.lineTo(t, e + i), r.arcTo(t, e, t + i, e, i)), u && (r.moveTo(n - i, e), r.lineTo(n, e), r.lineTo(n, e + i), r.arcTo(n, e, n - i, e, i)), f && (r.moveTo(n - i, o), r.lineTo(n, o), r.lineTo(n, o - i), r.arcTo(n, o, n - i, o, i)), l && (r.moveTo(t + i, o), r.lineTo(t, o), r.lineTo(t, o - i), r.arcTo(t, o, t + i, o, i)) }

    function f(r, t, e, n, o, i, f, l) {
        var c = r.isDark,
            g = n + i,
            s = o + i,
            h = e.radius * i,
            ...
            M = c(d, w),
            D = c(f, w);
        T ? a(t, n, o, g, s, h, !p && !D, !p && !E, !A && !E, !A && !D) : u(t, n, o, g, s, h, p && D && y, p && E && B, A && E && k, A && D && M) }

    function l(r, t, e) {
        var n, o, a = r.moduleCount,
            u = e.size / a,
            l = i;
        for (m && e.radius > 0 && e.radius <= .5 && (l = f), t.beginPath(), n = 0; a > n; n += 1)
            for (o = 0; a > o; o += 1) {
                var c = e.left + o * u,
                    g = e.top + n * u,
                    s = u;
                l(r, t, e, c, g, s, n, o) }
        if (d(e.fill).is("img")) { t.strokeStyle = "rgba(0,0,0,0.5)", t.lineWidth = 2, t.stroke();
    ...
    function c(r, e) {
        ...
        if (!n) return null;
        var i = d(r).data("qrcode", n),
            a = i[0].getContext("2d");
        return o(n, a, e), l(n, a, e), i }

    function g(r) {
        var t = d("<canvas/>").attr("width", r.size).attr("height", r.size);
        return c(t, r) }

    function s(r) {
        return d("<img/>").attr("src", g(r)[0].toDataURL("image/png")) }

    function h(r) {
        var e = t(r.text, r.ecLevel, r.minVersion, r.maxVersion, r.quiet);
        if (!e) return null;
        var n, o, i = r.size,
            a = r.background,
            u = Math.floor,
            ...
            s = { position: "absolute", padding: 0, margin: 0, width: l, height: l, "background-color": r.fill },
            h = d("<div/>").data("qrcode", e).css(g);
        for (a && h.css("background-color", a), n = 0; f > n; n += 1)
            for (o = 0; f > o; o += 1) e.isDark(n, o) && d("<div/>").css(s).css({ left: c + o * l, top: c + n * l }).appendTo(h);
        return h }

    function v(r) {
        return w && "canvas" === r.render ? g(r) : w && "image" === r.render ? s(r) : h(r) }
    var d = jQuery,
        w = function() {
    ...
    d.fn.qrcode = function(r) {
        var t = d.extend({}, T, r);
        return this.each(function() { "canvas" === this.nodeName.toLowerCase() ? c(this, t) : d(this).append(v(t)) }) };
    var y = function() {
        function r(t, e) {
            ...
            return o.get = function(r) {
                return n[r] }, o.getLength = function() {
                return n.length }, o.multiply = function(t) {
                for (var e = new Array(o.getLength() + t.getLength() - 1), n = 0; n < o.getLength(); n += 1)
                    for (var i = 0; i < t.getLength(); i += 1) e[n + i] ^= a.gexp(a.glog(o.get(n)) + a.glog(t.get(i)));
                return r(e, 0) }, o.mod = function(t) {
        ...
        var t = function(t, e) {
            var o = 236,
                ...
                w = new Array,
                m = {},
                T = function(r, t) { h = 4 * c + 17, s = function(r) {
                        for (var t = new Array(r), e = 0; r > e; e += 1) { t[e] = new Array(r);
                            for (var n = 0; r > n; n += 1) t[e][n] = null }
                        return t }(h), y(0, 0), y(h - 7, 0), y(0, h - 7), E(), B(), A(r, t), c >= 7 && k(r), null == d && (d = C(c, g, w)), M(d, t) },
                y = function(r, t) {
                    for (var e = -1; 7 >= e; e += 1)
                        if (!(-1 >= r + e || r + e >= h))
                            for (var n = -1; 7 >= n; n += 1) - 1 >= t + n || t + n >= h || (s[r + e][t + n] = e >= 0 && 6 >= e && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) || e >= 2 && 4 >= e && n >= 2 && 4 >= n ? !0 : !1) },
                p = function() {
                    for (var r = 0, t = 0, e = 0; 8 > e; e += 1) { T(!0, e);
                    ...
                    for (var e = -1, n = h - 1, o = 7, a = 0, u = i.getMaskFunction(t), f = h - 1; f > 0; f -= 2)
                        for (6 == f && (f -= 1);;) {
                            for (var l = 0; 2 > l; l += 1)
                                if (null == s[n][f - l]) {
                                    var c = !1;
                                    a < r.length && (c = 1 == (r[a] >>> o & 1));
                                    var g = u(n, f - l);
                                    g && (c = !c), s[n][f - l] = c, o -= 1, -1 == o && (a += 1, o = 7) }
                            if (n += e, 0 > n || n >= h) { n -= e, e = -e;
                                break } } },
                D = function(t, e) {
                ...
                C = function(r, t, e) {
                    ...
                    for (l.getLengthInBits() + 4 <= 8 * s && l.put(0, 4); l.getLengthInBits() % 8 != 0;) l.putBit(!1);
                    for (;;) {
            ...
            return m.addData = function(r) {
                var t = l(r);
                w.push(t), d = null }, m.isDark = function(r, t) {
                if (0 > r || r >= h || 0 > t || t >= h) throw new Error(r + "," + t);
                return s[r][t] }, m.getModuleCount = function() {
                return h }, m.make = function() { T(!1, p()) }, m.createTableTag = function(r, t) { r = r || 2, t = "undefined" == typeof t ? 4 * r : t;
                var e = "";
                e += '<table style="', e += " border-width: 0px; border-style: none;", e += " border-collapse: collapse;", e += " padding: 0px; margin: " + t + "px;", e += '">', e += "<tbody>";
                for (var n = 0; n < m.getModuleCount(); n += 1) { e += "<tr>";
                    ...
                    e += "</tr>" }
                return e += "</tbody>", e += "</table>" }, m.createImgTag = function(r, t) { r = r || 2, t = "undefined" == typeof t ? 4 * r : t;
        ...
        t.stringToBytes = function(r) {
            for (var t = new Array, e = 0; e < r.length; e += 1) {
                ...
                t.push(255 & n) }
            return t }, t.createStringToBytes = function(r, t) {
            var e = function() {
        ...
        var e = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
            ...
            i = function() {
                ...
                return f.getBCHTypeInfo = function(r) {
                    ...
                    return (r << 10 | t) ^ u }, f.getBCHTypeNumber = function(r) {
                    for (var t = r << 12; l(t) - l(i) >= 0;) t ^= i << l(t) - l(i);
                    return r << 12 | t }, f.getPatternPosition = function(r) {
                    return t[r - 1] }, f.getMaskFunction = function(r) {
                    switch (r) {
                        case o.PATTERN000:
                            return function(r, t) {
                                return (r + t) % 2 == 0 };
                        ...
                        default:
                            throw new Error("bad maskPattern:" + r) } }, f.getErrorCorrectPolynomial = function(t) {
                    for (var e = r([1], 0), n = 0; t > n; n += 1) e = e.multiply(r([1, a.gexp(n)], 0));
                    return e }, f.getLengthInBits = function(r, t) {
                    if (t >= 1 && 10 > t) switch (r) {
                        ...
                        switch (r) {
                            ...
                            case e.MODE_KANJI:
                                return 12;
                            default:
                                throw new Error("mode:" + r) } } }, f.getLostPoint = function(r) {
            ...
            f = function() {
                ...
                return e.getBuffer = function() {
                    return r }, e.get = function(t) {
                    var e = Math.floor(t / 8);
                    return 1 == (r[e] >>> 7 - t % 8 & 1) }, e.put = function(r, t) {
                    for (var n = 0; t > n; n += 1) e.putBit(1 == (r >>> t - n - 1 & 1)) }, e.getLengthInBits = function() {
                    return t }, e.putBit = function(e) {
            ...
            l = function(r) {
                ...
                return i.getMode = function() {
                    return n }, i.getLength = function() {
                    return o.length }, i.write = function(r) {
                    for (var t = 0; t < o.length; t += 1) r.put(o[t], 8) }, i },
            c = function() {
                var r = new Array,
                    t = {};
                return t.writeByte = function(t) { r.push(255 & t) }, t.writeShort = function(r) { t.writeByte(r), t.writeByte(r >>> 8) }, t.writeBytes = function(r, e, n) { e = e || 0, n = n || r.length;
                    for (var o = 0; n > o; o += 1) t.writeByte(r[o + e]) }, t.writeString = function(r) {
                    for (var e = 0; e < r.length; e += 1) t.writeByte(r.charCodeAt(e)) }, t.toByteArray = function() {
                    return r }, t.toString = function() {
                    var t = "";
                    t += "[";
            ...
            g = function() {
                ...
                return o.writeByte = function(n) {
                    for (r = r << 8 | 255 & n, t += 8, e += 1; t >= 6;) i(r >>> t - 6), t -= 6 }, o.flush = function() {
                    if (t > 0 && (i(r << 6 - t), r = 0, t = 0), e % 3 != 0)
                        for (var o = 3 - e % 3, a = 0; o > a; a += 1) n += "=" }, o.toString = function() {
                    return n }, o },
            s = function(r) {
                var t = r,
                    e = 0,
            ...
            h = function(r, t) {
                var e = r,
                    ...
                    o = new Array(r * t),
                    i = {};
                i.setPixel = function(r, t, n) { o[t * e + r] = n }, i.write = function(r) { r.writeString("GIF87a"), r.writeShort(e), r.writeShort(n), r.writeByte(128), r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(255), r.writeByte(255), r.writeByte(255), r.writeString(","), r.writeShort(0), r.writeShort(0), r.writeShort(e), r.writeShort(n), r.writeByte(0);
                    var t = 2,
                        o = u(t);
                    r.writeByte(t);
                ...
                var a = function(r) {
                    ...
                    f = function() {
                        ...
                        return e.add = function(n) {
                            ...
                            r[n] = t, t += 1 }, e.size = function() {
                            return t }, e.indexOf = function(t) {
                            return r[t] }, e.contains = function(t) {
                            return "undefined" != typeof r[t] }, e };
                return i },
            v = function(r, t, e, n) {

...
import * as AddWfTitleAction from '../../actions/addwf/title';
...
const mapStateToProps = state => {
    const { eaddwftitle } = state;
    return ({
        tabid: eaddwftitle.get("tabid")
    })
}

function mapDispatchToProps(dispatch) {
    return {
        actions: bindActionCreators(AddWfTitleAction, dispatch)
    }
}

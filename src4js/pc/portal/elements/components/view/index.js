...
import * as ViewAction from '../../actions/view/';
...
class View extends React.Component {
    componentDidMount(){
        ...
        if(!_isEmpty(config.toJSON())){
            actions.initViewConfig(config.toJSON());
        }
    }
...
View = WeaTools.tryCatch(React, MyErrorHandler, { error: "" })(View);
...
function mergeProps(stateProps, dispatchProps, ownProps) {
    ...
    return {
        ...
        data: stateProps.data.get(eid) || Immutable.fromJS(ecLocalStorage.getObj("portal-" + window.global_hpid, "view-" + eid, true) || {}),

...
window.__defaultTemplNamespace__ = (function(){
	return (function(){
		return {
...
window.initLayoutForCss = initLayoutForCss;
//@deprecated
function initLayout(){

...
(function ($, undefined) {
	...
	$.extend(Selectbox.prototype, {
		...
		_attachSelectbox: function (target, settings) {
            ...
            /*閹碘晛鐫峜sswith鐏炵儑鎷?閿燂拷閿燂拷閿燂拷,閺嶈宓乻elect濡楀棛娈戞妯哄閸旑煉鎷?閿燂拷閿熷€燁啎缂冿拷閿燂拷*/
			...
			if(parentWidth>30 && parseInt(tarwidth)>parentWidth && !$target.attr("_notParent")){
...
window.beautySelect = beautySelect;

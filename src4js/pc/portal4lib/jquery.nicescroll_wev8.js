      ...
      this.doScrollPos = function(x,y,spd) {  //trans
        ...
        self.timer = setTimeout(function(){
          ...
          if (ms>0) {
            ...
            if (!self.cursorfreezed) self.timerscroll.tm=setInterval(function(){if(self.me.is(":visible")===false)return;self.showCursor(self.getScrollTop(),self.getScrollLeft())},60);

...
export default function list(state = initialState, action) {
    switch (action.type) {
      	case types.LISTDONE_TABLE_COL_SET_VISIBLE:
      		return state.merge({colSetVisible: action.value});
    	case types.LISTDONE_TABLE_COL_SET:
        ...
        case types.LISTDONE_INIT_DATAS:
        ...
        case types.LISTDONE_RESET_DATAS:
        ...
        case types.LISTDONE_SET_SPAFORM:

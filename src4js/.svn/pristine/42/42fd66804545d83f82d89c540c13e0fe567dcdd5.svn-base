...
SWFUpload.prototype.getFlashVars = function () {
	...
	if (typeof(this.settings.secid) != "undefined") { 
		ajax({
		"method" : "get",
		"url": "/docs/docs/saveforupload.jsp?secid="+this.settings.secid,//请求地址
		//dataType:"json",
		"async":false,
		"success":function(msg){ 
			var config=eval("("+msg+")");
			params+="&amp;fileTypes="+encodeURIComponent(config['message']);
		  },
		  "error":function(msg){
...
SWFUpload.prototype.buildParamString = function () {
	...
	if(""!=postParams["secId"] && typeof(postParams["secId"]) != "undefined"){

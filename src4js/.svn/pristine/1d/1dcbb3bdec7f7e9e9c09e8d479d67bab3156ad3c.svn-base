...
class OpToolbar extends React.Component {
        ...
        render() {
           const { eid, ebaseid, toolbar, clsname } = this.props;
...
OpToolbar = WeaTools.tryCatch(React, MyErrorHandler, {
    error: ""
})(OpToolbar);
...
export default connect(mapStateToProps, mapDispatchToProps)(OpToolbar);

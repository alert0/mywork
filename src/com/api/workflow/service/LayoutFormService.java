...
public class LayoutFormService {
	 ...
	 */
	public Map<String,Object> generateFormData(HttpServletRequest request, HttpServletResponse response,Map<String,Object> params) throws Exception{
		this.init(request, response, params);
		int ismode = Util.getIntValue(Util.null2String(params.get("ismode")));
		this.ismanagePage = Util.null2String(params.get("ismanagePage"));

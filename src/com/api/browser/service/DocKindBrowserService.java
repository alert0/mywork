 ...
 * 
 */
public class DocKindBrowserService extends BrowserService {
	...
	public Map<String, Object> getBrowserData(Map<String, Object> params) throws Exception {
		...
		String tableString =" <table id='DocInstancyLevelTable' instanceid='DocInstancyLevelTable' tabletype='none' pagesize=\"10\">"+ 
							"<sql backfields=\""+backfields+"\" sqlform=\" DocSendDocKind \" sqlwhere=\""+sqlwhere+"\"  sqlorderby=\""+orderby+"\"  sqlprimarykey=\"id\" sqlsortway=\"asc\"/>"+
							"<head>"+

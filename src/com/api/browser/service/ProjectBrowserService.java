...
public class ProjectBrowserService extends BrowserService {
	...
	public Map<String, Object> getBrowserData(Map<String, Object> params) throws Exception{
		...
		tableString += "	<sql backfields=\"" + backfields + "\" sqlform=\"" + Util.toHtmlForSplitPage(sqlfrom)
				+ "\" sqlwhere=\"\"  sqlorderby=\"t1.id\"  sqlprimarykey=\"t1.id\" sqlsortway=\"desc\" sqlisdistinct=\"false\" />";
		tableString += " <head>" + "		<col hide=\"true\" width=\"5%\" text=\"\" column=\"id\"/>" + "		<col width=\"20%\" text=\"" + SystemEnv.getHtmlLabelNames("195", user.getLanguage())
				+ "\" column=\"name\" orderkey=\"name\" />" + "		<col width=\"20%\" text=\"" + SystemEnv.getHtmlLabelNames("586", user.getLanguage())
				+ "\" column=\"prjtype\"  display=\"true\"  transmethod=\"weaver.proj.Maint.ProjectTypeComInfo.getProjectTypename\"/>" + " 	<col width=\"20%\" text=\""
				+ SystemEnv.getHtmlLabelNames("432", user.getLanguage()) + "\" column=\"worktype\"  display=\"true\"  transmethod=\"weaver.proj.Maint.ProjectTypeComInfo.getProjectTypename\" />"
				+ " 	<col width=\"20%\" text=\"" + SystemEnv.getHtmlLabelNames("144", user.getLanguage())
				+ "\" column=\"manager\"  display=\"true\"  transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />" + " 	<col width=\"20%\" text=\""
				+ SystemEnv.getHtmlLabelNames("587", user.getLanguage()) + "\" column=\"status\"  display=\"true\"  transmethod=\"weaver.proj.Maint.ProjectStatusComInfo.getProjectStatusdesc\"/>"
				+ " </head>" + "</table>";
